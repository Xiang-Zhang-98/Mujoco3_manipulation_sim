...
class Fanuc_mujoco_env(gymnasium.Env):
    def __init__(self, render=False):
        ...
        self.observation_space = spaces.Box(low=-10., high=10., shape=self.get_RL_obs().shape)
