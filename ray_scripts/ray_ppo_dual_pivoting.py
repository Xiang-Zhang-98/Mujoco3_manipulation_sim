...
config = (  # 1. Configure the algorithm,
    ...
    .rollouts(num_rollout_workers=24,rollout_fragment_length=20)
    .framework("torch")
    .training(model={"fcnet_hiddens": [256, 256]},train_batch_size=5000)
    .evaluation(evaluation_num_workers=1)
)
warm_start_trail = "PPO_dual_pivoting_-dist_w_rot_lim_w_robot_dist_f0.3_ws_H40_final_reward_100_trail2"
trail_name = "PPO_dual_pivoting_w_both_reward"
